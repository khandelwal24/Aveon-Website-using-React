        ...
        <div class="max-w-[1260px] mx-auto sm:px-9 px-7 relative overflow-hidden">
          <div class="grid lg:grid-cols-4 md:grid-cols-2 gap-5 text-white" style={{fontFamily:'Orbitron'}}>
            ...
            <div class="backdrop-blur-lg bg-opacity-30 text-center opacity-90 space-y-2 group hover:bg-gradient-to-r from-cyan-500 to-blue-500 ... py-2 rounded-xl border-x-[1px] border-cyan-500 hover:scale-105 hover:transition-all duration-100 hover:text-black">
                ...
                <p>Active Social Media followers</p>
            </div>
            {/* <!-- 2nd block --> */}
            <div class="backdrop-blur-lg bg-opacity-30 text-center opacity-90 space-y-2 group hover:bg-gradient-to-r from-cyan-500 to-blue-500 ... rounded-xl border-x-[1px] border-cyan-500 hover:scale-105 hover:transition-all duration-100 hover:text-black">
